...
import { Settings, History, Grid3X3, BarChart3, Search, RefreshCcw, TableProperties, PieChart, ScrollText, FileText, BookOpen, Zap, Globe, Wallet, Eye, EyeOff } from 'lucide-react';
...
const NAV_ITEMS = [
    ...
    { name: 'Portfolio Maintainer', icon: Wallet,        path: '/portfolio-maintainer' },
];
